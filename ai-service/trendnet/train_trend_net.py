...
A diferencia del enfoque anterior (LinearRegression sobre el precio
promedio por año, ~12 puntos por modelo), esta red se entrena sobre las
2,000 muestras SIN AGREGAR del dataset sintético de price_dataset.py,
usando solo el año y el modelo como entrada (ignorando kilometraje,
condición, etc., que aquí actúan como ruido natural). Con más datos
crudos, la red aprende la tendencia real de forma más robusta que
ajustando una recta sobre unos pocos promedios.
"""
